...
public class FileIO {
    ...
    static void createFile() throws IOException{
        ...
        try{
            ...
            //create content on file created
            ...
            switch(choice){
                case 1:
                    ...
                    Path writtenFile = Files.write(filePath, bs);
                    System.out.println("Content Written in file\n"+ new String(Files.readAllBytes(writtenFile))+".txt");
                    break;
                case 2:
                    break;
            }
    ...
    static void fileRead(){
            ...
            try{
                ...
                switch(choice){
                    case 1:  
                        System.out.print("Write Content: \n"+new String(content)); // make content editable
                        fileName = in.next();
                        String editContent = fileName;
                        byte[] bs = editContent.getBytes();
                        Path writtenPath = Files.write(filePath, bs);
                        System.out.println("Content Written in file\n"+ new String(Files.readAllBytes(writtenPath))+".txt");
                        break;
                    case 2:
